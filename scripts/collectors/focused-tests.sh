...
jq -e 'type=="object" and (has("status") or has("findings") or has("focused_test_violations") or has("skipped_test_marker_violations") or has("violations"))' "$INPUT" >/dev/null 2>&1 \
