...
- [x] Version references agree with the actual tag state (`v2.2.0` latest, tag `99fcd276`; `v2.0.1` and `v2.0.0` superseded engine-only releases; `v1.9.2` supported prior stable line).
