...
**Current baseline:** `master` = `88b2c4ee34891780dbb45e6379746d6cb7b443c8` · 13 blocking workflows expected on `push` (12 + `ci-backlog-reconciliation`) · **158 open issues** = **143 findings + 15 epics** (14 created to organise the backlog, plus #38, an audit-era tracker repurposed as the M5 epic rather than closed and re-filed).

**Original audit baseline:** `8f146d11`, 158 findings, all open.

**Full acceptance evidence recorded for:** #310, #284, #285, #306, #326, #151, #259, #260, #264, #182, #350, #147, #146, #145 — see the closure comment on each.

**Open or reopened from findings surfaced BY the work:** #315, #316, #317, #318, #320, #323, #324, #344, #345, #348, #350, #365. The count going up is the programme working: each is a defect the remediation exposed, not one it created.
...
| M1 — Evidence Trust Foundation | #287 | 18 | 11 | #182 **done**; #310 **done**; #147 **done** — the atomic-publication primitive landed and unblocked #110, #129, #159 and #163; #146 **done** — the bounded-count contract landed and unblocked #106, #107, #108, #112, #119, #120, #121 and #122; #145 **done** — the collector output contract landed at the shared emitter (status vocabulary, status agreement, the four-class 68-key value contract, the 37-key gating census) and discharged #204's last blocker — the producer/channel identity split landed and all six criteria were audited through the builder on merged master; **#204 partial** — now unblocked, but all six producers emit the envelope and that is structural compliance only; C1 + C2 outstanding |
...
| M4 — Producer Chain Correctness | #290 (+#291–#299) | 68 | 50 | Per-producer correctness — **56 ready**, 12 blocked (11 on #204, 1 on #227; #215 also cites #234). The scanner evidence transaction batch (#96–#105, #135–#137, #184, #185) **merged** at `b23c37f9`, audited at 98/98 acceptance criteria — see [`m4-acceptance-audit.md`](m4-acceptance-audit.md) |
...
| ~~#146~~ ✓ | ~~8~~ | bounded safe-integer limits for all collector counts — **DONE**, PR #364. 2^31-1 for individual AND aggregate counts, overflow checked before addition; #106, #107, #108, #112, #119, #120, #121 and #122 became ready |
...
That mismatch is what #350 was: M4 records where the plan said `ready` and the label said `blocked` — 54 at first, 39 once the M4 scanner-evidence batch merged. They were carried as an enumerated `reconciliation_debt` list, keyed by `(issue, field)`, that can only shrink. It shrank to zero. The split was not a semantic disagreement at all: the labels were a 2026-08-06 bulk snapshot of the plan's own state that day, and #182 and #259 — the blockers those records declared — closed on 2026-08-08 without the labels following. The plan was authoritative, the 39 labels were corrected to match it, and the class was removed with its last entry. The list is empty and the mechanism stays, because the next drift must still be named before it can be excused.
