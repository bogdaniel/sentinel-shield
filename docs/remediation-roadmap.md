...
**Current baseline:** `master` = `912f92b3e0d565017a1aa2729284746eabacd1fc` · 13 blocking workflows expected on `push` (12 + `ci-backlog-reconciliation`) · **161 open issues** = **146 findings + 15 epics** (14 created to organise the backlog, plus #38, an audit-era tracker repurposed as the M5 epic rather than closed and re-filed).
...
| M1 — Evidence Trust Foundation | #287 | 21 | 14 | #182 **done**; #310 **done** — the producer/channel identity split landed and all six criteria were audited through the builder on merged master; **#204 partial** — all six producers emit the envelope, but that is structural compliance only; C1 + C2 outstanding |
