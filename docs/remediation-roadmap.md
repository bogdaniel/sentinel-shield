...
**Current baseline:** `master` = `d3e268af9a06c032846484b2ef4c28c772f1b8d1` · 13 blocking workflows expected on `push` (12 + `ci-backlog-reconciliation`) · **160 open issues** = **145 findings + 15 epics** (14 created to organise the backlog, plus #38, an audit-era tracker repurposed as the M5 epic rather than closed and re-filed).
